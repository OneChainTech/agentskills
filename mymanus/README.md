...
3.  **DeepSeek API Key**: 或兼容 OpenAI 格式的提供商（如 SiliconFlow, Together AI）。
...
*   `agent.py`: `ManusAgent` 核心类。处理 LLM 交互循环、工具调度和上下文管理。
